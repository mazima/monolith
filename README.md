[![Build Status](https://dev.azure.com/user04dev/user04dev/_apis/build/status/monolith-CI?branchName=master)](https://dev.azure.com/user04dev/user04dev/_build/latest?definitionId=2&branchName=master)
